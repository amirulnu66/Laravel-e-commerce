                ...
                <div class="card-media-list">
                    <div class="media clickable" data-qp-link="profiles-member-profile.html">
                        <div class="profile-picture bg-gradient bg-primary has-message float-right d-flex mr-3">
                            <img src="{{URL::to('backend')}}" width="44" height="44">
                        </div>
                    ...
                    <div class="media clickable" data-qp-link="profiles-member-profile.html">
                        <div class="profile-picture bg-gradient bg-primary has-message float-right d-flex mr-3">
                            <img src="{{URL::to('admin/assets/img/profile-pic-3.jpg')}}" width="44" height="44">
                        </div>
                        <div class="media-body">
                            <div class="heading mt-1">
                                Teal'c Jaffa
                    ...
                    <div class="media clickable" data-qp-link="profiles-member-profile.html">
                        <div class="profile-picture bg-gradient bg-secondary float-right d-flex mr-3">
                            <img src="{{URL::to('admin/assets/img/profile-pic-2.jpg')}}" width="44" height="44">
                        </div>
                        <div class="media-body">
                            <div class="heading mt-1">
                                Samantha Carter
                    ...
                    <div class="media clickable" data-qp-link="profiles-member-profile.html">
                        <div class="profile-picture bg-gradient bg-secondary has-message float-right d-flex mr-3">
                            <img src="{{URL::to('admin/assets/img/profile-pic-4.jpg')}}" width="44" height="44">
                        </div>
                        <div class="media-body">
                            <div class="heading mt-1">
                                General Landry
                    ...
                    <div class="media clickable" data-qp-link="profiles-member-profile.html">
                        <div class="profile-picture bg-gradient bg-primary float-right d-flex mr-3">
                            <img src="{{URL::to('admin/assets/img/profile-pic-6.jpg')}}" width="44" height="44">
                        </div>
                        <div class="media-body">
                            <div class="heading mt-1">
                                Jacklin O'neil
                        ...
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    ...
                                    <span class="custom-control-description">Mauris rutrum quam at porta feugiat</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description"><span class="badge badge-danger">Critical</span>Mauris rutrum quam at porta feugiat</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Fusce in felis nec exdf</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    ...
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description"><span class="badge badge-warning">High Priority</span>Aliquam vel tristique ipsum</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" checked>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description"><span class="badge badge-primary">Optional</span>Aenean vehicula, ligula sit amet varius maximus</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Etiam varius neque sed sagittis fringilla</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                        ...
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" checked>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description"><span class="badge badge-info">Low Priority</span>Sed velit augue, tincidunt vitae posuere</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description"><span class="badge badge-warning">High Priority</span>Fusce in felis nec exdf</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description"><span class="badge badge-info">Low Priority</span>Aliquam vel tristique ipsum</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                            <div class="checkbox" data-toggle="buttons">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description"><span class="badge badge-info">Low Priority</span>Aenean vehicula, ligula sit amet varius maximus</span>
                                </label>
                            </div>
                        </li>
                        <li class="task-list-item">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <div class="profile-picture bg-gradient bg-primary float-right d-flex mr-3">
                                            <img src="{{URL::to('admin/assets/img/profile-pic-5.jpg')}}" width="44" height="44">
                                        </div>
                                        <div class="media-body">
                                            <div class="heading mt-1">
                                                Daniella Jackson
